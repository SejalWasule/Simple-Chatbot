...
Original file is located at
    https://colab.research.google.com/drive/1pmJ7qrnkUZrIPQqYiXo3QxTHzp60NkCj
    ...
    "intents": [
       ...
       
       {
        ...
        },
        {
            ...
            "responses": [
                "I was made by Sejal and Poorvi."
            ]
        },
        {
            "tag": "insult",
        ...
        },
        {
            ...
            "responses": [
                "Please mail your suggestions to vermapb@rknec.edu or wasulesv@rknec.edu. Thank you for helping me improve!"
            ]
        },
            {"tag": "riddle",
            "patterns": [
        ...
        },
        {
            ...
            "responses": [
                "I was made in november 2022, if that's what you are asking, so technically I am a newborn ...lol!"
            ]
        }
    ]
}
...
adam = tf.keras.optimizers.Adam(learning_rate=0.005, decay=1e-6)
